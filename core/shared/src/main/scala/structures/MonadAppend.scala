 ...
 * define a universally quantified associative operation via the `combine` method.
 */
@typeclass trait MonadCombine[F[_]] extends Any with MonadFilter[F] with Alternative[F] {
